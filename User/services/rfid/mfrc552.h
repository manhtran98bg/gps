...
#define	CS_H()		GPIO_SetBits(MFRC522_GPIO, MFRC522_CS_PIN)	/* Set MMC CS "high" */
#define CS_L()		GPIO_ResetBits(MFRC522_GPIO, MFRC522_CS_PIN)	/* Set MMC CS "low" */
