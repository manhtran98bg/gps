...
#include "spi/spi.h"		/* Include device specific declareation file here */
...
#define	CS_H()		GPIO_SetBits(SPI_GPIO, SPI_CS)	/* Set MMC CS "high" */
#define CS_L()		GPIO_ResetBits(SPI_GPIO, SPI_CS)	/* Set MMC CS "low" */
